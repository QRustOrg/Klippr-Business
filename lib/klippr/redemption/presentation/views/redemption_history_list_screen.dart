...
import '../../../promotions/application/bloc/promotions_state.dart';
    ...
    switch (tab) {
      ...
      case KlipprTab.miLista:
        Navigator.of(context).pushReplacement(
          PromotionsRouter.active(context.read<PromotionsBloc>()),
        );
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.of(context).push(
                    RedemptionRouter.historyForPromotion(promo.id.value),
                  );
                },
                child: Container(
